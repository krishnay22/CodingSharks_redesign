...
const NewComponent = () => {
  const [percentage, setPercentage] = useState(65); // Example percentage
      ...
      <div className="third-rectangle-box">
        ...
        <div className="web-dev-line"></div>
          ...
          <CircularProgressbar
            value={percentage}
            text={`${percentage}%`}
            styles={buildStyles({textColor: "#333",pathColor: "#ff6600",trailColor: "#d6d6d6", })} />
          </div>
          </div>
         <style jsx>{`
          ...
          /* Top Line */
          .top-line {
            width: 117%; /* Full width of the parent container */
          ...
          /* Rectangle Box */
          .rectangle-box {
            width: 66%; /* Width of the rectangle box */
            max-width: 75%; /* Maximum width */
            margin-left: 83px;
            height: 100px; /* Reduced height for shorter box */
            ...
            position: relative; /* Allows for movement with top/bottom */
            top: -97px;
          }
          .rectangle-box:hover {
          ...
          .second-rectangle-box h4 {
            ...
            .event-line {
            width: 97%; /* Full width of the container */
            height: 1px; /* Thinner line (reduced from 2px to 1px) */
            background-color: #ff996e; /* Default color */
            margin-top: -9px; /* Space between the "Events" title and the line */
          }
          ...
          .third-rectangle-box {
            ...
            height: 162px; /* Height of the third rectangle */
          ...
          width: 97%; /* Full width of the container */
            ...
            background-color: #ff996e; /* Default color */
            margin-top: -11px; /* Space between the "News" title and the line */
          }
  
          /* Styling for the nested rectangle inside the third rectangle */
           .third-rectangle-box .nested-rectangle {
            width: 99%; /* Width of the nested rectangle */
            max-width: 800px; /* Maximum width */
            height: 98px; /* Height of the nested rectangle */
            background-color:white; /* Slightly darker grey for the nested box */
            border-radius: 17px; /* Rounded corners for the nested rectangle */
          ...
          /* Right-side box styles */
           .right-side-box {
            ...
            height: 356px; /* Set the desired height */
            background-color: white;
            border-radius: 10px;
            ...
            align-items: center;
            z-index: 10;
            border: 2px solid #382f2f; /* Black border */
          }
          ...
          .structure-list .has-line::after {
            ...
            .progress-icon {
              margin-top: 40px; /* Adjust the spacing between the list and the icon */
              color: #ff996e;   /* Set the color for the icon */
            display: block;    /* Ensures it takes up full width on the line */
            margin-left: -157px;
          }
