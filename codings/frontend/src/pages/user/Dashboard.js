...
const NewComponent = () => {
  ...
  return (
    <div className="new-component">
      ...
      <style jsx>{`
         ...
         /* Rectangle Box */
         .rectangle-box {
         width: 64%; /* Width of the rectangle box */
         ...
         .second-rectangle-box h4 {
           ...
           background-color: #ff996e; /* Default color */
            margin-top: -28px; /* Space between the "Events" title and the line */
         }
 ...
 .third-rectangle-box h4 {
         ...
         width: 97%; /* Full width of the container */
           ...
           background-color: #ff996e; /* Default color */
           margin-top: -9px; /* Space between the "News" title and the line */
         }
